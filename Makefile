...
TCP_SERVER_DEPS = tcp_server_main.c lexer.c parser.c bptree.c jungle_benchmark.c executor.c bench_memtrack.h jungle_benchmark.h lexer.h parser.h bptree.h executor.h types.h platform_threads.h $(CMD_PROCESSOR_DIR)/cmd_processor.h $(CMD_PROCESSOR_DIR)/cmd_processor_sync_bridge.h $(CMD_PROCESSOR_DIR)/engine_cmd_processor.h $(CMD_PROCESSOR_DIR)/engine_cmd_processor_internal.h $(CMD_PROCESSOR_DIR)/tcp_cmd_processor.h $(CMD_PROCESSOR_DIR)/tcp_protocol_binary.h $(CMD_PROCESSOR_DIR)/cmd_processor.c $(CMD_PROCESSOR_DIR)/cmd_processor_sync_bridge.c $(CMD_PROCESSOR_DIR)/engine_cmd_processor_support.c $(CMD_PROCESSOR_DIR)/engine_cmd_processor_planner.c $(CMD_PROCESSOR_DIR)/engine_cmd_processor_runtime.c $(CMD_PROCESSOR_DIR)/engine_cmd_processor.c $(CMD_PROCESSOR_DIR)/tcp_cmd_processor.c $(CMD_PROCESSOR_DIR)/tcp_protocol_binary.c $(CJSON_DIR)/cJSON.c $(CJSON_DIR)/cJSON.h
...
TCP_CMD_PROCESSOR_TEST_SRC = $(CMD_PROCESSOR_DIR)/tcp_cmd_processor_test.c $(CMD_PROCESSOR_DIR)/tcp_cmd_processor.c $(CMD_PROCESSOR_DIR)/tcp_protocol_binary.c $(CMD_PROCESSOR_DIR)/cmd_processor.c $(CMD_PROCESSOR_DIR)/mock_cmd_processor.c $(CJSON_DIR)/cJSON.c
TCP_CMD_PROCESSOR_TEST_DEPS = $(TCP_CMD_PROCESSOR_TEST_SRC) $(CMD_PROCESSOR_DIR)/tcp_cmd_processor.h $(CMD_PROCESSOR_DIR)/tcp_protocol_binary.h $(CMD_PROCESSOR_DIR)/cmd_processor.h $(CMD_PROCESSOR_DIR)/mock_cmd_processor.h $(CJSON_DIR)/cJSON.h
...
$(TCP_SERVER_TARGET): $(TCP_SERVER_DEPS)
	$(CC) $(CFLAGS) -I$(CMD_PROCESSOR_DIR) -I$(CJSON_DIR) $(TCP_SERVER_SRC) lexer.c parser.c bptree.c jungle_benchmark.c executor.c $(CMD_PROCESSOR_DIR)/cmd_processor.c $(CMD_PROCESSOR_DIR)/cmd_processor_sync_bridge.c $(CMD_PROCESSOR_DIR)/engine_cmd_processor_bundle.c $(CMD_PROCESSOR_DIR)/tcp_cmd_processor.c $(CMD_PROCESSOR_DIR)/tcp_protocol_binary.c $(CJSON_DIR)/cJSON.c -o $(TCP_SERVER_TARGET) -pthread
